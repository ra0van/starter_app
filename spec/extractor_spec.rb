...
RSpec.describe Extractor, type: :service do
  describe '#extract_and_save_ads' do
    it 'extracts and inserts ad data correctly' do
      # Mock Facebook API data
      api_data = [{ 'id' => '1', 'name' => 'Ad 1', 'adset_id' => '1', 'account_id' => 'A1' }]

      # Execute the transformation
      extractor = Extractor.new
      extractor.extract_and_save_ads(api_data)
    ...
    context 'when the same ad is to be updated, ad data is upserted correctly' do
      it 'extracts and upserts ad data correctly' do
        # Mock Facebook API data
    ...
    context 'when the input data is missing required fields' do
      it 'raises an error' do
        ...
        # Execute the transformation
        extractor = Extractor.new
        expect { extractor.extract_and_save_ads(data) }.to raise_error(ArgumentError)
      end
    end
  end
  ...
  describe '#extract_and_save_ad_insights' do
    it 'extracts and upserts ad insights data correctly' do
      ...
      # Execute the transformation
      extractor = Extractor.new
      extractor.extract_and_save_ad_insights(api_data)
    ...
    context 'when the input data contains invalid values' do
      it 'raises an error' do
        ...
        # Execute the transformation
        extractor = Extractor.new
        expect { extractor.extract_and_save_ad_insights(data) }.to raise_error(ArgumentError)
      end
    end
  ...
  describe '#extract_and_save_adsets' do
    it 'extracts and inserts adset data correctly' do
      # Mock Facebook API data
      api_data = [{ 'id' => '1', 'name' => 'Adset 1', 'campaign_id' => '1', 'account_id' => 'A1' }]

      # Execute the transformation
      extractor = Extractor.new
      extractor.extract_and_save_ad_sets(api_data)
    ...
    context 'when the input data is missing required fields' do
      it 'raises an error' do
        ...
        # Execute the transformation
        extractor = Extractor.new
        expect { extractor.extract_and_save_ad_sets(data) }.to raise_error(ArgumentError)
      end
    end
  end
  ...
  describe '#extract_and_save_adset_metrics' do
    it 'extracts and upserts adset metrics data correctly' do
      ...
      # Execute the transformation
      extractor = Extractor.new
      extractor.extract_and_save_adset_insights(api_data)
    ...
    context 'when the input data is missing required fields' do
      it 'raises an error' do
        ...
        # Execute the transformation
        extractor = Extractor.new
        expect { extractor.extract_and_save_adset_insights(data) }.to raise_error(ArgumentError)
      end
    end
  ...
  describe '#transform_campaigns' do
    it 'extracts and inserts campaign data correctly' do
      # Mock Facebook API data
      api_data = [{ 'id' => '1', 'name' => 'Campaign 1', 'account_id' => 'A1', 'start_time' => '2022-01-01' }]

      # Execute the transformation
      extractor = Extractor.new
      extractor.extract_and_save_ad_campaigns(api_data)
    ...
    context 'when the same campaign is to be updated, ad data is upserted correctly' do
      it 'extracts and upserts campaign  data correctly' do
        # Mock Facebook API data
    ...
    context 'when the input data is missing required fields' do
      it 'raises an error' do
        ...
        # Execute the transformation
        extractor = Extractor.new
        expect { extractor.extract_and_save_ad_campaigns(data) }.to raise_error(ArgumentError)
      end
    end
  end

  describe '#transform_campaign_metrics' do
    it 'extracts and inserts campaign metrics data correctly' do
      # Mock Facebook API data
      api_data = [{ 'clicks' => 100, 'ctr' => 0.1, 'inline_link_clicks' => 50, 'date_stop' => '2022-01-01',
      ...
      # Execute the transformation
      extractor = Extractor.new
      extractor.extract_and_save_adcampaign_insights(api_data)
    ...
    context 'when the input data is missing required fields' do
      it 'raises an error' do
        ...
        # Execute the transformation
        extractor = Extractor.new
        expect { extractor.extract_and_save_adcampaign_insights(data) }.to raise_error(ArgumentError)
      end
    end
  ...
  describe '#extract_and_save_ad_accounts' do
    it 'extracts and inserts ad account data correctly' do
      # Mock Facebook API data
      api_data = [{ 'id' => 'A1', 'name' => 'Account 1', 'currency' => 'USD' }]

      # Execute the transformation
      extractor = Extractor.new
      extractor.extract_and_save_ad_accounts(api_data)
    ...
    context 'when the same ad account is to be updated, ad account data is upserted correctly' do
      it 'extracts and upserts ad account data correctly' do
        # Mock Facebook API data
    ...
    context 'when the input data is missing required fields' do
      it 'raises an error' do
        ...
        # Execute the transformation
        extractor = Extractor.new
        expect { extractor.extract_and_save_ad_accounts(data) }.to raise_error(ArgumentError)
      end
    end
  end

  describe '#extract_and_save_adaccount_insights' do
    it 'extracts and inserts ad account insights data correctly' do
      # Mock Facebook API data
      api_data = [{ 'clicks' => 100, 'ctr' => 0.1, 'inline_link_clicks' => 50, 'date_stop' => '2022-01-01',
      ...
      # Execute the transformation
      extractor = Extractor.new
      extractor.extract_and_save_adaccount_insights(api_data)
    ...
    context 'when the input data is missing required fields' do
      it 'raises an error' do
        ...
        # Execute the transformation
        extractor = Extractor.new
        expect { extractor.extract_and_save_adaccount_insights(data) }.to raise_error(ArgumentError)
      end
    end

    context 'when the same ad account insights data is to be updated, insights data is upserted correctly' do
      it 'extracts and upserts ad account insights data correctly' do
        # Mock Facebook API data
